...
<template>
    ...
    <div class="w-fit mx-auto">
        ...
        <input type="text" maxlength="255" placeholder="Заголовок" class="w-full mb-5"/>
        ...
        <label for="file" class="w-full link">
        ...
        <NuxtLink @click="addPost" class="link ml-auto">Добавить</NuxtLink>
    </div>
</template>
...
<style scoped>
    input[type=text] {
        padding: 8px 16px;
        border-radius: 16px;
        background-color: var(--iskra-surface-variant);
        color: var(--iskra-on-surface-variant);
    }
