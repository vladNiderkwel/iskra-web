...
<template>
    ...
    <div class="flex my-4 justify-evenly">
        ...
        <ButtonFilledPrimary text="Проверить" @click="navigateTo('/task/check/')" />

        <ButtonFilledPrimary text="Добавить" @click="navigateTo('/task/add')">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
        ...
        <template v-else>
            ...
            <template v-else>
                <template v-for="task in data.content">
                    ...
                    <DeletedTaskCard :task="task" class="my-3 mx-auto" v-else />
                </template>
