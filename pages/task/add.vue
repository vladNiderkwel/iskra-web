...
<template>
    ...
    <a @click="openAddSectionMenu" class="mx-auto my-4 link">
    ...
    <div>
        <div v-for="t in newTask.tasks" class="task-card mx-auto my-2">
            ...
            <a @click="deleteSection(t.id)" class="ml-auto w-fit h-fit link-round">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
    ...
    <div v-if="isAddSectionMenuVisible" class="absolute flex left-0 top-0 w-full h-full add-background">
        <div v-if="isAddTypeSelectMenuVisible" class="block add-menu mx-auto my-auto rounded-2xl h-auto p-3">
            <a @click="closeAddSectionMenu" class="ml-auto w-fit h-fit link-round">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
            ...
            <a @click="moveToAddOptionScreen" class="mx-auto mt-4 w-fit h-fit link-pink-variant">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
        ...
        <div v-if="isAddOptionsMenuVisible" class="block add-menu mx-auto my-auto rounded-2xl h-auto p-3">
            ...
            <div v-if="newSection.type != 2"  class="flex mb-4">
                ...
                <a @click="addOption" class="w-fit h-fit link-round outline">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                        <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/>
                    </svg>
                </a>
            ...
            <div v-for="(opt, index) in newSection.options" class="my-2">
                <div class="flex option max-w-full">
                    <p class="my-auto mr-auto break-words">{{ opt.text }}</p>
                    <a @click="deleteOption(opt.id)" class="ml-auto my-auto w-fit h-fit link-round">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                            <path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/>
                        </svg>
                    </a>
                </div>
                <HorizontalDivider v-if="index < newSection.options.length - 1" class="mt-2"/>
            </div>

            <div class="flex mt-8">
                <a @click="openAddSectionMenu(); clear();" class="mr-auto w-fit h-fit link-pink-variant">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                ...
                <a @click="addSection(); closeAddSectionMenu();" class="w-fit h-fit link-pink-variant">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                        <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/>
                    </svg>
...
<style scoped>
    ...
    .task-card {
        ...
        background: var(--iskra-secondary-container);
    }
