...
<template>
    <ul class="list-none flex flex-col navigation">
        <li class="flex">
            <a @click="toggle">
            ...
            <NuxtLink v-if="isVisible" class="w-fit !p-2 !ml-auto" to="/home">
                <svg width="36" height="36" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17 31C20.609 34.6091 22.6551 42.9072 23.5141 47.2449C23.604 47.6986 24.396 47.6986 24.4859 47.2449C25.3449 42.9072 27.3909 34.6091 31 31C34.609 27.3909 42.9072 25.3449 47.2448 24.4859C47.6986 24.396 47.6986 23.604 47.2448 23.5141C42.9072 22.6551 34.609 20.6091 31 17C27.3909 13.3909 25.3449 5.09275 24.4859 0.75515C24.396 0.301405 23.604 0.301403 23.5141 0.755147C22.6551 5.09275 20.609 13.3909 17 17C13.3909 20.6091 5.09274 22.6551 0.755147 23.5141C0.301402 23.604 0.301404 24.396 0.755149 24.4859C5.09275 25.3449 13.3909 27.3909 17 31Z"/>
                </svg>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/user">
                ...
                <p v-show="isVisible" class="ml-3">Пользователи</p>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/map">
                ...
                <p v-show="isVisible" class="ml-3">Карта</p>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/event">
                ...
                <p v-show="isVisible" class="ml-3">События</p>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/question">
                ...
                <p v-show="isVisible" class="ml-3">Вопросы</p>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/task">
                ...
                <p v-show="isVisible" class="ml-3">Задания</p>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/service">
                ...
                <p v-show="isVisible" class="ml-3">Модули</p>
            </NuxtLink>
        </li>
        <li>
            <NuxtLink to="/post">
                ...
                <p v-show="isVisible" class="ml-3">Посты</p>
            </NuxtLink>
        </li>
        <li class="!mt-auto">
            <NuxtLink to="/">
                ...
                <p v-show="isVisible" class="ml-3">Выход</p>
            </NuxtLink>
        </li>
    </ul>
</template>