<template>
    <ul class="list-none flex flex-col">
        ...
        <li class="mt-auto">
            <NuxtLink class="mx-auto w-fit" to="/login">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
...
<style scoped>
    ...
    ul .router-link-active, ul .router-link-active:hover {
